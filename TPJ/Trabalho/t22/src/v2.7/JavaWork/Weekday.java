...
public class Weekday implements Serializable {
    ...
    HashMap<Integer, Lesson> hmMorningLessons;
    HashMap<Integer, Lesson> hmEveningLessons;
    ...
    Weekday(int id) {
        morning = new HashMap<Integer, Boolean>(4);
        morning.put(8, false);
        morning.put(9, false);
        ...
        evening = new HashMap<Integer, Boolean>(5);
        ...
        hmMorningLessons = new HashMap<>(4);
        hmEveningLessons = new HashMap<>(5);
